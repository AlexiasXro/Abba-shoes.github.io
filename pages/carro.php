<?php
require_once('c://xampp/htdocs/AbbaR/components/header.html')
...
<section class="shop container">
    ...
    <div class="shop-content">
        ...
        <div class="product-box">
            <img src="../../img/Producto/zapanegra.jpg" alt="#" class="product-img">
            <h2 class="product-title">Bota0</h2>
        ...
        <div class="product-box">
            <img src="../../img/Producto/zapanegra.jpg" alt="#" class="product-img">
            <h2 class="product-title">Bota1</h2>
            <span class="price">$5500</span>
            <i class="bx bx-shopping-bag add-cart"></i>
        </div>
        ...
        <div class="product-box">
            <img src="../../img/Producto/zapanegra.jpg" alt="#" class="product-img">
            <h2 class="product-title">Bota2</h2>
            <span class="price">$5500</span>
            <i class="bx bx-shopping-bag add-cart"></i>
        </div>
...
<?php
require_once('c://xampp/htdocs/AbbaR/components/footer.html')
